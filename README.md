...
Status: Functional prototype with automated calculation tests and hardware smoke testing; calibration against a known load is the next validation step.
...
Once measured the data will stored in PostgreSQL, and visualized with Grafana, displaying Current power draw, Daily energy usage, Historical trends, and Estimated cost
